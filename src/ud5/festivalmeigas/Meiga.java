...
public class Meiga implements Comparable<Meiga>{
    ...
    private int lanzarFeitizos() {
        int puntos = 0;
        Comparator<Feitizo> compDificultad = (f1, f2) -> f1.getDificultade() - f2.getDificultade();
        feitizos.sort(compDificultad.reversed());
    ...
    public String toString() {
        ...
        Comparator<Feitizo> compDificultad = (f1, f2) -> f1.getDificultade() - f2.getDificultade();
        Comparator<Feitizo> compNome = Comparator.naturalOrder();
        feitizos.sort(compDificultad.reversed().thenComparing(compNome));
        str += "Feitizos: " + feitizos + "\n";

        Set<String> ingredientes = new TreeSet<>(inventario.keySet());
        str += "Inventario: " + ingredientes;
